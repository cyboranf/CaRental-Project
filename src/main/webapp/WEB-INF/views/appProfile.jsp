...
<div class="m-4 p-3 width-medium">
    ...
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        ...
        <div class="row border-bottom border-3 p-1 m-1">
            ...
            <div class="col noPadding d-flex justify-content-end mb-2"><a href="/app/show/AccessKeys"
            ...
            <c:forEach items="${carList}" var="car" varStatus="loopStatus">
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                        <a href="/app/car/details/${car.id}" class="btn btn-info rounded-0 text-light m-1">Details about rent</a>
                    </td>
                </tr>
